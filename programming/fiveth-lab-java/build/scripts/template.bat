...
set CLASSPATH=%APP_HOME%\lib\template-1.0-SNAPSHOT.jar;%APP_HOME%\lib\gson-2.10.1.jar


@rem Execute template
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %TEMPLATE_OPTS%  -classpath "%CLASSPATH%" main.Application %*
